...
if (d[0] == 1) {
    ...
    console.log("Falso! O valor ", d[0], " do elemento do índice 0 da variável 'd' não é igual a 1"); //else
}

// Escreva depois dos ':' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): 
if (d[1] == 1) {
    console.log("Verdade! O valor ", d[1], " do elemento do índice 1 da variável 'd' é igual a 1"); //if
} else {
